...
select has_function('public', 'course_eligibility(bigint,date)', 'course eligibility function exists');
select has_function('public', 'course_completion_summary(bigint,date,bigint)', 'completion summary function exists');
