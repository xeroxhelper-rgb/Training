...
const functionsMigration = readFileSync("supabase/migrations/0005_product_v2_functions.sql", "utf8");
...
describe("v2 schema migration contract", () => {
  ...
  it("keeps employment-history ordering inside the lateral lookup", () => {
